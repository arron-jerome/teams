...
public abstract class ObjectUtils {
    ...
    public static <T extends Comparable<T>> boolean eq(T source, T target) {
        if (source == target) {
            return true;
        }
    ...
    public static <T extends Comparable<T>> boolean ne(T source, T target) {
        return !eq(source, target);
    }
    ...
    public static <T extends Comparable<T>> int compareTo(T source, T target) {
        if (source == null) {
    ...
    public static <T extends Comparable<T>> boolean between(T source, T min, T max) {
        return lte(min, source) && lte(source, max);
    }

    public static <T extends Comparable<T>> boolean betweenIgnoreNull(T source, T min, T max) {
        if (source == null) {
            return true;
        }
        ...
        if (min == null) {
            if (max == null) {
                ...
                return ObjectUtils.lte(source, max);
            }
        }
        if (max == null) {
            return ObjectUtils.lte(min, source);
        }
